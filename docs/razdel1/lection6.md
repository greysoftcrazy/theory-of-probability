...
2. найдем значение функции  $$\varphi(x) = {1 \over \sqrt{2\pi}}e^{-{x^2 \over 2}}$$ для $$x = 2,33$$ по таблице [приложения 1](../pril1.md): $$\varphi(2,33) \approx 0,026$$;   
...
Таблица значений функции Лапласа приведена в [приложении 2](../pril2.md).
...
$$x_1 =  {230-700·0,35 \over {700·0,35·0,65}} = {-15 \over 12,6} = -1,19$$; 
$$x_2 =  {270-700·0,35 \over {700·0,35·0,65}} = {25 \over 12,6} = 1,98$$

Значения функции Лапласа при $$x = -1,19$$ и $$x = 1,98$$ возьмем из таблицы [приложения 2](../pril2.md)
