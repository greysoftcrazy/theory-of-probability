...
В силу [закона больших чисел](../../GLOSSARY.md#закон-больших-чисел) можно утверждать, что выборка будет репрезентативной, если ее осуществлять случайно.
...
Если задан интервальный вариационный ряд, то для составления эмпирической функции распределения находят середины интервалов и по ним получают [эмпирическую функцию распределения](../../GLOSSARY.md#эмпирическая-функция-распределения) аналогично точечному вариационному ряду.
