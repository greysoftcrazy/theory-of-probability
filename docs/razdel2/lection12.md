...
Определенные по результатам достаточно большого числа испытаний характеристики случайных явлений ([относительные частоты](../../GLOSSARY.md#относительная-частота), средние арифметические) используют в качестве приближенного решения задачи (в качестве оценок вероятностей, [математических ожиданий](../../GLOSSARY.md#математическое-ожидание-дсв)). Допустимость этого приближения основывается на [законе больших чисел](../../GLOSSARY.md#закон-больших-чисел).
...
1. Случайная величина Х распределена нормально Хϵ N($$m$$;$$\sigma$$) с известным среднеквадратическим отклонением $$\sigma$$. Это значит, что с [надежностью](../../GLOSSARY.md#надежность) $$\gamma$$ верхняя граница ошибки равна
...
С [надежностью](../../GLOSSARY.md#надежность)  $$ \gamma = 0,95$$ найти верхнюю границу ошибки для оценки [математического ожидания](../../GLOSSARY.md#математическое-ожидание-дсв) случайной величины Хϵ N($$m$$; 0,6), если было разыграно 25 возможных значений $$n$$. 
...
Найти верхнюю границу ошибки с надежностью $$ \gamma = 0,95$$, если для оценки [математического ожидания](../../GLOSSARY.md#математическое-ожидание-дсв) было разыграно 100 возможных значений Х и по этим данным найдено «исправленное» среднеквадратическое отклонение $$S = 0,4$$.
...
По заданным вероятностям четырех событий, образующих [полную группу событий](../../GLOSSARY.md#полная-группа-случайных-событий) $$p_1 = P(A_1) = 0,18$$; $$p_2 = P(A_2) = 0,25;$$ $$p_3 = P(A_3) = 0,36$$; $$p_4 = P(A_4) = 0,21$$ разыграть пять испытаний, в каждом из которых должно появиться одно из этих событий.

*Решение*. 

По правилу разыгрывания полной группы событий надо разыграть ДСВ, имеющую [закон распределения](../../GLOSSARY.md#закон-распределения) 
...
1. По правилу разыгрывания полной группы событий надо разыграть ДСВ,  имеющую [закон распределения](../../GLOSSARY.md#закон-распределения):
